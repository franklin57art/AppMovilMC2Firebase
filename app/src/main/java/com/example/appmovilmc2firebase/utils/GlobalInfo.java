...
public class GlobalInfo {
    ...
    public static final String URL_UPDATE_PUNTO_DE_MEDIDA = "http://192.168.1.62/sys__connections?token=no&except=id_conn&nameId=id_conn&id=";
    ...
    public static final String URL_UPDATE_CLIENT = "http://192.168.1.62/sys__clients?token=no&except=id_client&nameId=id_client&id=";
